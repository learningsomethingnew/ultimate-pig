...
class Player():
    ...
    def set_total_points(self, a_value):
    ...
    def track_game_stats(self, a_win=0):
        ...
        self.set_total_points_list(self.get_total_points())
    ...
    def set_total_points_list(self, a_value):
        self.total_points_list.append(a_value)

    """Returns list of the total points list"""
    def get_total_points_list(self):
        return self.total_points_list
...
class roll_five_then_hold(Player):
    def choose_roll_hold(self):
        if len(self.get_dice_values_per_role()) < 6:
            return 'roll'
        else:
            return 'hold'
